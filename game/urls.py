...
urlpatterns = [
    ...
    path('contingency_perturbed/', views.contingency_perturbed, name='contingency_perturbed'),
    path('contingency_click/', views.contingency_click, name='contingency_click'),
    path('shuffle_keys_click/', views.shuffle_keys_click, name='shuffle_keys_click'),
